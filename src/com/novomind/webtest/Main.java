...
public class Main implements Runnable {
  ...
  public static void printHelp() {
    ...
    System.out.println(
        " 1 user requests for one minute with a delay of 10 seconds the site www.shop.com over and over. The second url is requested only once (-s) and has additional POST information.");
  }
